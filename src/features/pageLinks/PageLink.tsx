...
const pageLinkSuggestionKey = new PluginKey("pageLinkSuggestion");

const pageLinkSuggestion: Omit<SuggestionOptions<PageLinkItem>, "editor"> = {
  char: "[[",
  pluginKey: pageLinkSuggestionKey,
  allowSpaces: true,
  ...
  render: createSuggestionRender(PageLinkList, pageLinkSuggestionKey),
};
