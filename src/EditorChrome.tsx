...
import { insertImageFile, looksLikeImageFile } from "./imageInsert";
import {
  getEditorMarkdown,
  parseStoredContent,
  serializeDoc,
...
import { migrateInlineImages } from "./migrateInlineImages";
import { containsMarkdownExtras, rewriteTaskListHTML } from "./pasteTransforms";
import { LinkPopover } from "./LinkPopover";
import { MathPopover, type MathEditTarget } from "./MathPopover";
...
export function EditorChrome({
  ...
  return (
    <div className="rdump-editor-wrap">
      {showTopbar ? (
          ...
          <div className="rdump-editor-scroll" ref={scrollRef}>
            ...
            {ui.bubbleMenu ? (
              <BubbleMenu editor={editor} className="rdump-bubble">
                <BubbleBar editor={editor} onRequestLink={openLinkEditor} />
              </BubbleMenu>
            ) : null}
